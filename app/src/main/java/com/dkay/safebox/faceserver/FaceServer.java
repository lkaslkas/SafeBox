package com.dkay.safebox.faceserver;
...
import com.dkay.safebox.application.SafeBoxApplication;
import com.dkay.safebox.facedb.FaceDatabase;
import com.dkay.safebox.facedb.entity.FaceEntity;
import com.dkay.safebox.model.CompareResult;
import com.dkay.safebox.util.ErrorCodeUtil;
import com.dkay.safebox.util.ImageUtil;
...
public class FaceServer {
    ...
    public synchronized int clearAllFaces() {
        ...
        Context applicationContext = SafeBoxApplication.getApplication().getApplicationContext();
    ...
    private String getImageDir() {
        return SafeBoxApplication.getApplication().getApplicationContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES)
    ...
    public CompareResult searchFaceFeature(FaceFeature faceFeature, FaceEngine faceEngine) {
        ...
        try {
            ...
            if (searchResult != null) {
                ...
                FaceEntity faceEntity = FaceDatabase.getInstance(SafeBoxApplication.getApplication()).faceDao().queryByFaceId(faceFeatureInfo.getSearchId());
                if (faceEntity != null) {
