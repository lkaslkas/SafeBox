package com.dkay.safebox.util.debug;
...
import com.dkay.safebox.util.ConfigUtil;
import com.dkay.safebox.util.FileUtil;
import com.dkay.safebox.util.debug.model.BasicInfo;
...
public class DebugInfoDumper {
    ...
    static {
        LOG_ROOT_DIR = SafeBoxApplication.getApplication().getExternalFilesDir("debugDump").toString();
        CRASH_LOG_DIR = SafeBoxApplication.getApplication().getExternalFilesDir("crashLog").toString();
    }
    ...
    public static String getBasicInfo() {
        Context context = SafeBoxApplication.getApplication().getApplicationContext();
